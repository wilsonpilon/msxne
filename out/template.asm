...
;--------------------------------------------------------
	.area _CODE
;./template.c:37: void main()
;	---------------------------------
; Function main
; ---------------------------------
_main::
;./template.c:39: VDP_SetMode(VDP_MODE_SCREEN5);
	ld	a, #0x06
	call	_VDP_SetMode
...
;./template.c:42: VDP_ClearVRAM();
	call	_VDP_ClearVRAM
;./template.c:44: Print_SetBitmapFont(g_Font_MGL_Sample6);
...
;C:/msx/engine/src/print.h:224: g_PrintData.CursorY = y;
	ld	hl, #(_g_PrintData + 7)
	ld	(hl), #0x00
;./template.c:54: Print_DrawChar(g_ChrAnim[count++ % 4]);
	inc	c
	ld	a, c
	and	a, #0x03
	ld	e, a
